    ...
    <div class="container-fluid">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cointopay" class="form-horizontal">
            <script type="text/javascript">
                ...
                {
                    $.ajax({
                        url:'index.php?route=extension/payment/cointopay/getMerchantCoinsByAjax&token=<?php echo $token?>',
                        type:'post',
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-general">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" name="cointopay_sort_order" value="<?php echo $cointopay_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
						</div>
				    </div>
                </div>
            </div>
